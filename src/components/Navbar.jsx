...
const Navbar = () => {
  ...
  return (
    <nav
      className={`${styles.paddingX} w-full flex items-center py-5 z-20 fixed top-0 bg-primary`}>
      <div
        ...
        >
          ...
          />
          <div
            className={`${!toggle ? "hidden" : "flex"} p-6 bg-gray-800 absolute top-20 right-0 mx-4 my-2 min-w-[140px] z-10 rounded-xl`}
          >
